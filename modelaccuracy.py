...
model = neuralnetwork.NeuralNetwork3()
model.load_state_dict(torch.load("/home/jikenaga2/model5"))
model.eval()
...
newnum = neuralnetwork.model_validate(model, x_test_tensor,y_test_tensor)
print(newnum)